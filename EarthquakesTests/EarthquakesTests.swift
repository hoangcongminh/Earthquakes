...
final class EarthquakesTests: XCTestCase {
    ...
    func testGeoJSONDecoderDecodesQuake() throws {
        ...
        let expectedSecond = TimeInterval(1636129710550) / 1000
        let decodedSecond = quake.time.timeIntervalSince1970
        
        XCTAssertEqual(expectedSecond, decodedSecond, accuracy: 0.00001)
    }
    ...
    func testGeoJSONDecoderDecodesGeoJSON() throws {
        ...
        let expectedSecond = TimeInterval(1636129710550) / 1000
        let decodedSecond = decoded.quakes[0].time.timeIntervalSince1970
        XCTAssertEqual(expectedSecond, decodedSecond, accuracy: 0.00001)
    }
